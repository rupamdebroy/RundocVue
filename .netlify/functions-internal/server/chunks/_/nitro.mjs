...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "6e88be1d-cc13-453b-89f5-24338be3b935",
...
const _lazy_XJiAcJ = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_XJiAcJ, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_XJiAcJ, lazy: true, middleware: false, method: undefined }
];
